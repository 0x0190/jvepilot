...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    {"jvePilot.settings.accEco", {PERSISTENT, BOOL, "1"}},
    {"jvePilot.settings.accEco.speedAheadLevel1", {PERSISTENT, STRING, "7"}},
    {"jvePilot.settings.accEco.speedAheadLevel2", {PERSISTENT, STRING, "5"}},
    {"jvePilot.settings.accEco.longAccelLevel1", {PERSISTENT, STRING, "1.5"}},
    {"jvePilot.settings.accEco.longAccelLevel2", {PERSISTENT, STRING, "1.0"}},
    {"jvePilot.settings.autoFollow", {PERSISTENT, BOOL, "1"}},
    {"jvePilot.settings.autoFollow.speed1-2Bars", {PERSISTENT, STRING, "15"}},
    {"jvePilot.settings.autoFollow.speed2-3Bars", {PERSISTENT, STRING, "30"}},
    {"jvePilot.settings.autoFollow.speed3-4Bars", {PERSISTENT, STRING, "65"}},
    ...
    {"jvePilot.settings.slowInCurves.speedRatio", {PERSISTENT, STRING, "1.0"}},
    {"jvePilot.settings.slowInCurves.speedDropOff", {PERSISTENT, STRING, "2.0"}},
    {"jvePilot.settings.slowInCurves.speedDropOffAngle", {PERSISTENT, STRING, "0.0"}},
